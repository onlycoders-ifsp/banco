CREATE OR REPLACE FUNCTION FN_EFETUA_ALUGUEL(P_ID_USUARIO TEXT, P_ID_PRODUTO TEXT, P_DATA_INICIO TEXT, P_DATA_FIM TEXT, P_VALOR_ALUGUEL DOUBLE PRECISION, P_USUARIO TEXT DEFAULT '')
    RETURNS BOOLEAN AS $$
