CREATE OR REPLACE FUNCTION FN_VALIDA_ALUGUEL(P_ID_USUARIO TEXT, P_ID_PRODUTO TEXT, P_DATA_INICIO TEXT, P_DATA_FIM TEXT, P_USUARIO TEXT DEFAULT '')
RETURNS TEXT AS $$
BEGIN
	...
	EXCEPTION WHEN OTHERS THEN
		PERFORM FN_REPORT_ERRO('ERRO AO VALIDAR ALUGUEL', SQLSTATE, SQLERRM, 'FN_VALIDA_ALUGUEL', 'ALUGUEIS', CURRENT_QUERY(), P_USUARIO);
		Return '0';
