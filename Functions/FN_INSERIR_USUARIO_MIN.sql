...
BEGIN
	...
	IF P_LOGIN IS NULL OR P_LOGIN = '0' THEN
		P_LOGIN := P_EMAIL;
	END IF;
	...
	ELSE
		BEGIN
			RETURN QUERY SELECT 
			IDUSUARIO, NOME, EMAIL, CPF, CELULAR, ATIVO
			FROM FN_RETORNA_USUARIO('0')
			AS T(IDUSUARIO TEXT,NOME TEXT,EMAIL TEXT,LOGIN TEXT,CPF TEXT,CELULAR TEXT,ATIVO BOOLEAN);
