...
FN_ATUALIZA_PRODUTO(P_ID_PRODUTO TEXT, P_NOME TEXT, P_DESCRICAO_CURTA TEXT,P_DESCRICAO TEXT, 
					...
					P_DATA_COMPRA TEXT, P_ATIVO BOOLEAN,P_USUARIO TEXT DEFAULT '')
RETURNS BOOLEAN AS $$
DECLARE OK BOOLEAN;
BEGIN
	...
	EXCEPTION WHEN OTHERS THEN
		PERFORM FN_REPORT_ERRO('ERRO AO ATUALIZAR PRODUTO', SQLSTATE, SQLERRM, 'FN_ATUALIZA_PRODUTO', 'PRODUTOS', CURRENT_QUERY(),P_USUARIO);
		RETURN FALSE;
END;
$$ LANGUAGE PLPGSQL;