...
FN_ATUALIZA_PRODUTO(P_ID_PRODUTO TEXT, P_NOME TEXT, P_DESCRICAO_CURTA TEXT,P_DESCRICAO TEXT, 
					...
					P_VALOR_PRODUTO DOUBLE PRECISION, P_DATA_COMPRA TEXT, P_CAPA_FOTO TEXT)
RETURNS BOOLEAN AS $$
BEGIN
	UPDATE PRODUTOS
	...
	VALOR_PRODUTO = P_VALOR_PRODUTO, DATA_COMPRA = TO_DATE(P_DATA_COMPRA,'YYYY-MM-DD'), CAPA_FOTO = P_CAPA_FOTO
